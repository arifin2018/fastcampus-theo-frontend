...
const login = () =>{
    ...
    return(
        <section className="h-[75vh] flex items-center justify-center">
            <Card className="w-[35rem] border-2 border-gray-200">
                <CardHeader>
                ...
                <CardContent  className="border-y-2 border-gray-300 pt-1">
                    <div className="flex flex-col m-2">
                        ...
                        <input onChange={(e) => setUsername(e.target.value)} className="block w-full border-2 rounded-md border-gray-400 p-1" type="text" id="Username" />
                    </div>
                    <div className="flex flex-col m-2">
                        <label htmlFor="Password" className="flex items-start w-full font-semibold py-1">Password</label>
                        <input onChange={(e) => setPassword(e.target.value)}  className="block w-full  border-2 rounded-md border-gray-400 p-1" type={CheckboxShowPassword ? "text" : "password"} id="Password" />
                    </div>
                ...
                <CardFooter className="flex flex-col justify-center pt-2 items-center w-full">
                    <Button onClick={() => console.log(Username, Password)} className="block w-full pt-2">Login</Button>
